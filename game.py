...
if len(sys.argv)==3:
	...
	print(f"""
\033[1;31;40mอย่าลืมกดติดตามด้วยหล่ะ จะทำคลิปดีๆ แบบนี้อีก
\033[1;37;40mแก้ไขส่วนต่างๆ โดย GAMEZ GAMING
\033[1;34;40mใช้ในการจัดการพวกเกรียนไม่อนุญาติให้ใช้ยิงคนอื่นไปทั่ว
\033[1;37;40mอย่ามีความสุขบนความทุกของคนอื่นนะครับ อันนี้ผมขอถ้าจะเอาไปใช้ 
\033[1;31;40mห้ามนำไปแจกด้วย นะครับ ติดตามช่อง GAMEZ GAMING ด้วย
              
	""")

	phone = input("\033[1;33;40m+ ใส่เบอร์ : ")
	amount = int(input("\033[1;33;40m+ ใส่จำนวน : "))
	os.system("clear")
...
def game01():
    ...
    print (f"\033[1;32;40mส่ง SMS ไปที่เบอร์ {phone} | สำเร็จ ✓ เป็นจำนวน {amount}")
def game02():
