...
if len(sys.argv)==3:
	...
	print("""
อย่าลืมกดติดตามด้วยหล่ะ จะทำคลิปดีๆ แบบนี้อีก
แก้ไขส่วนต่างๆ โดย GAMEZ GAMING
ใช้ในการจัดการพวกเกรียนไม่อนุญาติให้ใช้ยิงคนอื่นไปทั่ว
อย่ามีความสุขบนความทุกของคนอื่นนะครับ อันนี้ผมขอถ้าจะเอาไปใช้ 
ห้ามนำไปแจกด้วย นะครับ
              
	""")

	phone = input("+ ใส่เบอร์ : ")
	amount = int(input("+ ใส่จำนวน : "))
	os.system("clear")
